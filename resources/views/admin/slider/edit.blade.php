                            ...
                            <div class="basic-form">
                                ...
                                <form method="POST"  action="{{ route('admin.slider.update', $slider->id) }}" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea id="caption" class="form-control" placeholder="Caption" name="content">{{ $slider->content }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row ">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            @if($slider->image)
                                                <div class="mt-2">
                                                    <p>Current Image:</p>
                                                    <img src="{{ asset('storage/'.$slider->image) }}" alt="Current Slider Image" class="img-thumbnail" style="max-width: 200px;">
                                                </div>
                                            @endif
