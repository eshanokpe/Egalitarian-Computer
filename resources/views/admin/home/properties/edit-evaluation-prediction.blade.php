            ...
            <div class="row"> 
                <div class="col-sm-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Edit Valuation Prediction</h4>
                    </div>
                    <!--end page-title-box-->
                </div>
                <!--end col-->
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Update Valuation Prediction</h4>
                                </div>
                                <div class="card-body">
                                    <form method="POST" action="{{ route('admin.properties.valuation.prediction.update', $propertyValuationPrediction->id ) }}" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="card">
                                            <div class="card-header">
                                            ...
                                            <div class="card-body">
                                                <input type="hidden" class="form-control" name="property_id" value="{{ $propertyValuationPrediction->property_id}}" placeholder="Enter Valuation type" required>
            
                                                <div class="row">
                                                    <div class="mb-3">
                                                        <label for="exampleInputEmail1">Enter Valuation Date</label>
                                                        <input type="text" class="form-control" name="valuation_type" value="{{ $propertyValuationPrediction->valuation_type}}" placeholder="Enter Valuation type" required>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input 
                                                            ...
                                                            value="{{ $property->price ? '₦' . number_format($propertyValuationPrediction->current_price, 2) : '' }}" 
                                                            required>
                                                            @error('current_price')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
